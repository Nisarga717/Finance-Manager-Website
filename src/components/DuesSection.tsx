...
const DuesSection: React.FC<DuesSectionProps> = ({ dues, onPaymentUpdate }) => {
  ...
  return (
    <div className="space-y-6">
      {/* You Owe Section */}
      {youOwe.length > 0 && (
        <Card className="border-l-4 border-l-red-500 bg-white/70 shadow-lg">
          <CardHeader>
          ...
          <CardContent>
            <div className="space-y-4">
              {youOwe.map((due) => (
                <div 
                  key={due.user_id}
                  className="flex items-center justify-between p-4 border border-purple-200 rounded-lg hover:bg-red-50 transition-colors"
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <p className="font-semibold text-purple-900">{due.user_name}</p>
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="text-right">
                      ...
                      <p className="text-xs text-purple-600">Amount Due</p>
                    </div>
      ...
      {/* Owed to You Section */}
      {owedToYou.length > 0 && (
        <Card className="border-l-4 border-l-green-500 bg-white/70 shadow-lg">
          <CardHeader>
          ...
          <CardContent>
            <div className="space-y-4">
              {owedToYou.map((due) => (
                <div 
                  key={due.user_id}
                  className="flex items-center justify-between p-4 border border-purple-200 rounded-lg hover:bg-green-50 transition-colors"
                >
                  <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="text-right">
                      ...
                      <p className="text-xs text-purple-600">Amount Owed</p>
                    </div>
      ...
      <Card className="bg-gradient-to-r from-purple-50 to-blue-50 border-purple-200 shadow-lg">
        <CardContent className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <div>
              <p className="text-sm font-medium text-purple-700 mb-1">Net Balance</p>
            ...
            <div>
              <p className="text-sm font-medium text-purple-700 mb-1">Total Transactions</p>
            ...
            <div>
              ...
              <Badge 
                ...
                className={dues.length === 0 ? "bg-green-100 text-green-800 border-green-200" : "bg-yellow-100 text-yellow-800 border-yellow-200"}
              >
